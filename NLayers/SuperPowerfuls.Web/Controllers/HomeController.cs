namespace SuperPowerfuls.Web.Controllers
{
    ...
    using SuperPowerfuls.Web.Constants;
    ...
    public class HomeController : Controller
    {
        ...
        private readonly ISuperPowersService _superPowerfulService;
        ...
        {
            var superPowerfuls = _superPowerfulService.GetAllSuperPowerfulsAndClassify();
            ViewBag.ResultFromClassify = (superPowerfuls.Heroes.Count > 0 || superPowerfuls.Villians.Count > 0) ?
                _superPowerfulService.AddVilliansAndHeroes(superPowerfuls.Villians, superPowerfuls.Heroes) : "Sin elementos a clasificar";

            return this.View(HomeControllerAction.Index, superPowerfuls);
        }
